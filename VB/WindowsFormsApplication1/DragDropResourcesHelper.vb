...
Namespace WindowsFormsApplication1
	Public Class DragDropResourcesHelper
		...
		Public Sub New(ByVal scheduler As SchedulerControl, ByVal fieldName As String)
			...
			Dim oldMouseHandler As IMouseHandlerService = DirectCast(CurrentScheduler.GetService(GetType(IMouseHandlerService)), IMouseHandlerService)
	...
	Public Class DragrDropMouseHandlerService
		...
		Public Overrides Sub OnMouseDown(ByVal e As PortableMouseEventArgs)
			downHitInfo = Nothing
			...
			End If
		End Sub
		Public Overrides Sub OnMouseMove(ByVal e As PortableMouseEventArgs)
			If e.Button = PortableMouseButtons.Left AndAlso downHitInfo IsNot Nothing Then
	...
	Public MustInherit Class ResourceBaseComparer
		...
		Protected Overridable Function CompareCore(ByVal x As Object, ByVal y As Object) As Integer
			...
			If xRes Is Nothing OrElse yRes Is Nothing Then
				Return 0
			End If
			If Object.Equals(xRes.Id, ResourceEmpty.Id) OrElse Object.Equals(yRes.Id, ResourceEmpty.Id) Then
				Return 0
			End If
